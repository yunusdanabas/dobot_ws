...
\begin{enumerate}
  ...
  \item \textbf{Verify:} \texttt{ping 192.168.2.7} — should respond with $<$\qty{1}{\ms} latency.
\end{enumerate}
...
\begin{tabularx}{0.8\linewidth}{@{}llX@{}}
  ...
  \midrule
  1 & 192.168.2.7  & \texttt{--robot 1} (default) \\
  2 & 192.168.2.9  & \texttt{--robot 2} \\
  3 & 192.168.2.10 & \texttt{--robot 3} \\
